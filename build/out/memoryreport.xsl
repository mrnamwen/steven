        ...
        <table cellpadding="5" border="2" align="center" style="font-family:Arial,sans-serif; font-size:10pt">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center"> <xsl:value-of select="memory_log/memory_summary/@TotalActiveExternalSize"/> bytes</td>
                </tr>
                <tr>
                    <td>Peak Active External Size</td>
                    <td align="center"> <xsl:value-of select="memory_log/memory_summary/@PeakActiveExternalSize"/> bytes</td>
                </tr>
                <tr>
                    <td>Accumulated External Size</td>
                    <td align="center"> <xsl:value-of select="memory_log/memory_summary/@AccumulatedExternalSize"/> bytes</td>
                </tr>
                <tr>
                    <td>Active External Alloc Count</td>
                    <td align="center"> <xsl:value-of select="memory_log/memory_summary/@ActiveExternalAllocCount"/></td>
                </tr>
                <tr>
                    <td>Peak Active External Alloc Count</td>
                    <td align="center"> <xsl:value-of select="memory_log/memory_summary/@PeakExternalActiveAllocCount"/></td>
                </tr>
                <tr>
                    <td>Total External Alloc Count</td>
                    <td align="center"> <xsl:value-of select="memory_log/memory_summary/@TotalExternalAllocCount"/></td>
                </tr>
                <tr>
